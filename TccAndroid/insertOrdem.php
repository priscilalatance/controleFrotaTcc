...
if ($resultadoConsulta->num_rows > 0) {
    ...
    $sql = "INSERT INTO ordemservico (placa, dataCheck, tipoManutencao, produtoCorretiva, statusOrdem, re) 
            VALUES ('$placaVeiculo', '$dataCheck', 'Corretiva', '$itensSelecionados', '$statusOrdem', '$reUsuario')";
