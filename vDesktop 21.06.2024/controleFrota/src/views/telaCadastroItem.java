...
public class telaCadastroItem extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tblCadastroItem.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        tblCadastroItem.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓD.", "DESCRIÇÃO PRODUTO", "MARCA", "MODELO", "COR", "ANO FAB.", "ANO MOD.", "VALOR UNIT.", "PROD. UNIV."
            }
        ));
        tblCadastroItem.setAutoscrolls(false);
        tblCadastroItem.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        tblCadastroItem.setRowHeight(35);
        tblCadastroItem.setRowMargin(10);
        tblCadastroItem.getTableHeader().setReorderingAllowed(false);
        ...
        if (tblCadastroItem.getColumnModel().getColumnCount() > 0) {
            tblCadastroItem.getColumnModel().getColumn(0).setResizable(false);
            tblCadastroItem.getColumnModel().getColumn(0).setPreferredWidth(15);
            tblCadastroItem.getColumnModel().getColumn(1).setResizable(false);
            tblCadastroItem.getColumnModel().getColumn(1).setPreferredWidth(550);
            tblCadastroItem.getColumnModel().getColumn(2).setResizable(false);
            tblCadastroItem.getColumnModel().getColumn(2).setPreferredWidth(40);
            tblCadastroItem.getColumnModel().getColumn(3).setResizable(false);
            tblCadastroItem.getColumnModel().getColumn(3).setPreferredWidth(40);
            tblCadastroItem.getColumnModel().getColumn(4).setResizable(false);
            tblCadastroItem.getColumnModel().getColumn(4).setPreferredWidth(40);
            tblCadastroItem.getColumnModel().getColumn(5).setResizable(false);
            tblCadastroItem.getColumnModel().getColumn(5).setPreferredWidth(38);
            tblCadastroItem.getColumnModel().getColumn(6).setResizable(false);
            tblCadastroItem.getColumnModel().getColumn(6).setPreferredWidth(42);
            tblCadastroItem.getColumnModel().getColumn(7).setResizable(false);
            tblCadastroItem.getColumnModel().getColumn(7).setPreferredWidth(60);
            tblCadastroItem.getColumnModel().getColumn(8).setResizable(false);
            tblCadastroItem.getColumnModel().getColumn(8).setPreferredWidth(50);
        }

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 680, 1180, 160));
        ...
        jPanel1.add(txtCodItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 120, 130, 30));
        ...
        jPanel1.add(txtMarca, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 320, 200, 20));
        ...
        jPanel1.add(txtModelo, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 320, 210, 20));
        ...
        jPanel1.add(txtCor, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 320, 190, 20));
        ...
        jPanel1.add(txtAnoFabri, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 320, 150, 20));
        ...
        jPanel1.add(jCheckBox1Universal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 310, 20, 20));
        ...
        jPanel1.add(txtCadastroItem_DescricaoItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 380, 640, 20));
        ...
        jPanel1.add(txtValorUnitario, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 380, 140, 20));
        ...
        jPanel1.add(txtAnoModelo, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 380, 110, 20));
        ...
        jPanel1.add(txtDescricaoItemConsul, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 590, 660, 20));
        ...
        jPanel1.add(btnConsultarItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 120, -1, 30));
        ...
        jPanel1.add(btnLimpar, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 120, 40, 30));
        ...
        jPanel1.add(btnLimparProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(1360, 370, -1, 40));
        ...
        jPanel1.add(btnLimparDesc, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 580, 30, 30));
        ...
        jPanel1.add(btnSalva_Cadastrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 370, 30, 40));
        ...
        jPanel1.add(btnAlterar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 370, 30, 30));
        ...
        jPanel1.add(btnConsultarItemDescr, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 580, 30, 30));

        jPanel2.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        lblConsCodProduto.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblConsCodProduto, javax.swing.GroupLayout.DEFAULT_SIZE, 632, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblConsCodProduto, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)
        );

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 660, 40));

        jPanel3.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        lblCadastrarProd.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblCadastrarProd, javax.swing.GroupLayout.DEFAULT_SIZE, 824, Short.MAX_VALUE))
        );
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblCadastrarProd, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)
        );

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 430, 840, 40));
        ...
        jPanel4Layout.setVerticalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addComponent(lblConsDescProd, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );

        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 630, 680, 40));
    ...
    private void btnSalva_CadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalva_CadastrarActionPerformed
        ...
        if(txtCadastroItem_DescricaoItem.getText().isEmpty() || txtValorUnitario.getText().isEmpty()){
            lblCadastrarProd.setText("Preencha os campos descrição e valor unitário.");
        ...
        if (resp == 1) {
            ...
            lblCadastrarProd.setText("Código de produto já cadastrado!");
            txtCodItem.setText("");
            txtCodItem.requestFocus();
        } else {
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        lblCadastrarProd.setText("Preencha o campo código de produto.");
        
        } else if(txtCadastroItem_DescricaoItem.getText().isEmpty() || txtValorUnitario.getText().isEmpty()){
            lblCadastrarProd.setText("Preencha os campos descrição e valor unitário.");
        ...
        if (status) {
            ...
            if (status) {
                ...
                lblCadastrarProd.setText("O produto não foi alterado.");
            }
            dao.desconectar();
        } else {
            lblCadastrarProd.setText("Erro na conexão com o Banco de Dados.");
    ...
    private void btnConsultarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarItemActionPerformed
        ...
        CadastroItemDao dao = new CadastroItemDao();
        if(txtCodItem.getText().isEmpty()){
        lblConsCodProduto.setText("Preencha o campo código de produto.");
        ...
        if (status == true) {
            ...
            lblConsCodProduto.setText("Erro na conexão com o Banco de Dados.");
        }
        dao.desconectar();
    ...
    private void btnConsultarItemDescrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarItemDescrActionPerformed
        ...
        if (status) {
            ...
            if (itensEncontrados.isEmpty()) {
                lblConsDescProd.setText("Não há cadastro para esta descrição.");
            } else {
                ...
                tblCadastroItem.getColumnModel().getColumn(0).setPreferredWidth(70);
                tblCadastroItem.getColumnModel().getColumn(1).setPreferredWidth(600);
                tblCadastroItem.getColumnModel().getColumn(2).setPreferredWidth(150);
                tblCadastroItem.getColumnModel().getColumn(3).setPreferredWidth(150);
                tblCadastroItem.getColumnModel().getColumn(4).setPreferredWidth(100);
                tblCadastroItem.getColumnModel().getColumn(5).setPreferredWidth(100);
                tblCadastroItem.getColumnModel().getColumn(6).setPreferredWidth(100);
                tblCadastroItem.getColumnModel().getColumn(7).setPreferredWidth(120);
                tblCadastroItem.getColumnModel().getColumn(8).setPreferredWidth(160);
