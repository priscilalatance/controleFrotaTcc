...
public class telaConsultarOSAberta extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(rbtOSPrevent, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 110, -1, -1));
        ...
        jPanel1.add(rbtOSCorret, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 110, -1, -1));
        ...
        tblOSPrevent.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        ...
        tblOSCorret.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        ...
        if (txtPlacaOS.getText().isEmpty()) {
            ...
            if (rbtOSCorret.isSelected()) {
                ...
                if (ordemCorretiva.isEmpty()) {
                    ...
                    tblOSCorret.getColumnModel().getColumn(0).setPreferredWidth(120);
                    tblOSCorret.getColumnModel().getColumn(1).setPreferredWidth(120);
                    tblOSCorret.getColumnModel().getColumn(2).setPreferredWidth(800);
