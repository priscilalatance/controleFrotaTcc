...
public class telaAgendamento extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tblConsHorarioBox.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        ...
        tblConsAgendamento.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        ...
        lblConsultarHorarioBox.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
        ...
        lblConsultarAgendamento.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
        ...
        lblAgendarVeiculo.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
    ...
    private void btnConsultarHorBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarHorBoxActionPerformed
        ...
        if (jdcConsultaDataPorHorarioBox.getDate() == null) {
            limpar();
            lblConsultarHorarioBox.setText("O campo data não pode ser vazio.");
    ...
    private void btnConsultarAgendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarAgendaActionPerformed
        ...
        if (jdcDataAgendamento.getDate() == null) {
            ...
            lblAgendarVeiculo.setText("O campo data não pode ser vazio.");
            ...
            lblAgendarVeiculo.setText("Não é possível fazer agendamento sem uma OS.");
            ...
            lblAgendarVeiculo.setText("A placa do veículo deve ser igual da OS Corretiva.");        
            ...
            lblAgendarVeiculo.setText("A placa do veículo deve ser igual da OS Preventiva.");
    ...
    private void btnExcluirAgendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirAgendaActionPerformed
        ...
        if (jdcDataAgendamento.getDate() == null) {
            ...
            if (status) {
                ...
                lblAgendarVeiculo.setText("Não foi possível fazer o cancelamento.");
            }
