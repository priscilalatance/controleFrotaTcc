...
public class telaCadastroItem extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtMarca, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 310, 200, 30));
        ...
        jPanel1.add(txtModelo, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 310, 210, 30));
        ...
        jPanel1.add(txtCor, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 310, 190, 30));
        ...
        jPanel1.add(txtAnoFabri, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 310, 150, 30));
        ...
        jPanel1.add(txtDescricaoItemConsul, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 580, 660, 30));
        ...
        jPanel1.add(btnLimparProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(1360, 370, -1, 30));
        ...
        jPanel1.add(btnSalva_Cadastrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 370, 30, 30));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 430, 660, 40));
    ...
    private void btnSalva_CadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalva_CadastrarActionPerformed
        ...
        if(txtCadastroItem_DescricaoItem.getText().isEmpty() || txtValorUnitario.getText().isEmpty()){
            lblCadastrarProd.setText("Descrição e Valor Unitário não pode estar vazio");
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        lblCadastrarProd.setText("Código de produto tem que ser preenchido");
    ...
    private void btnConsultarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarItemActionPerformed
        ...
        CadastroItemDao dao = new CadastroItemDao();
        if(txtCodItem.getText().isEmpty()){
        lblConsCodProduto.setText("Código de produto tem que ser preenchido");
