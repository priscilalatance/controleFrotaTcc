...
public class Veiculos {
	...
	private Boolean inativarVeiculo;
        private Integer KmManutRealizado;

    public Integer getKmManutRealizado() {
        return KmManutRealizado;
    }

    public void setKmManutRealizado(Integer KmManutRealizado) {
        this.KmManutRealizado = KmManutRealizado;
    }
